...
Crear\_perfil(mycursor, mydb, Usuari)
...
Cascadas/haarcascade\_frontalface\_alt2.xml
...
| `entrenament\_cares.py` | Facial dataset training script |
...
git clone https://github.com/Andormix/TorronteraRuiz\_M4\_REPTE.git

cd TorronteraRuiz\_M4\_REPTE
...
$env:MYSQL\_USER="your\_user"

$env:MYSQL\_PASSWORD="your\_password"

$env:MYSQL\_DATABASE="your\_database"
...
export MYSQL\_HOST="localhost"

export MYSQL\_USER="your\_user"

export MYSQL\_PASSWORD="your\_password"

export MYSQL\_DATABASE="your\_database"
